...
struct DEFAULTS def = { .Ncores=1, .class_pre="none",
                        .Npoints_z=65, .z_min=0.0, .z_max=6.0, .z_source=-1.0,
                        .Npoints_M=65, .M_min=1e11, .M_max=1e16,
                        .Npoints_signal=1024, .signal_min=0.0, .max_kappa=1.0, .max_tsz=2e-4,
                        .Npoints_theta=500, .rout_scale=2.0, .rout_rdef=hmpdf_mdef_v,
                        ...
                        .Nphi=1000, .phimax=150.0, .pixelexactmax=20,
                        ...
                        .zintegr_type=hmpdf_legendre, .zintegr_alpha=0.0, .zintegr_beta=0.0,
                        .Mintegr_type=hmpdf_legendre, .Mintegr_alpha=0.0, .Mintegr_beta=0.0,
