...
#define DT_DEP_ACTION(dt, expr)                                    \
    do {                                                           \
        ...
        {                                                          \
            ...
            case (mf_type) : expr(hmpdf_massfunc_mod_f); break;    \
...
{//{{{
    ...
    INIT_P(hmpdf_massfunc_mod,
           d->h->massfunc_mod, mf_type, def.massfunc_mod);
    INIT_P(hmpdf_massfunc_mod_params,
           d->h->massfunc_mod_params, vptr_type, def.massfunc_mod_params);
