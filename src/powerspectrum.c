...
{//{{{
    ...
    double *temp;
    SAFEALLOC(temp, malloc(d->ps->Nell * sizeof(double)));
...
{//{{{
    ...
    double *oneh_z;
    double *twoh_z;
    SAFEALLOC(oneh_z, malloc(d->ps->Nell * sizeof(double)));
    SAFEALLOC(twoh_z, malloc(d->ps->Nell * sizeof(double)));
...
{//{{{
    ...
    double *temp_ell;
    double *temp_Cell;
    SAFEALLOC(temp_ell,  malloc(d->ps->Nell_corr * sizeof(double)));
    SAFEALLOC(temp_Cell, malloc(d->ps->Nell_corr * sizeof(double)));
